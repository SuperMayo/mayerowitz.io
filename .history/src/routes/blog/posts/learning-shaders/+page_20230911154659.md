...
And voila, our baby's born. If you paid attention to the code, you may have noticed the `#define K 0.4` statement line 5. Like in C, it's a macro to define a constant, note that the name needs to be in caps to work properly.

[#TODO: explain the `define` line 5, the loop, the array, the map.]

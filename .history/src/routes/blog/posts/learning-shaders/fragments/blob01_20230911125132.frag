...
void main() {
    ...
    float d1 = circleSDF(st, c1, 0.772);
    float d2 = circleSDF(st, c2, 0.996);
    float d3 = circleSDF(st, c3, 0.908);
    float d4 = circleSDF(st, c4, 1.028);
    ...
    metaalt = 1. - step(u_slider, metaalt);

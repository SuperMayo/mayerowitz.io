...
void main() {
    ...
    float d1 = sdSphere(normalizedCoords, c1, 0.05);
    float d2 = sdSphere(normalizedCoords, c2, 0.02);
    float d3 = sdSphere(normalizedCoords, c3, 0.01);
    float d4 = sdSphere(normalizedCoords, c4, 0.1);

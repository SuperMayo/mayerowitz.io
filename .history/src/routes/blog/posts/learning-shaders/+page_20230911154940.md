...
And voila, our baby's born. You should now be ready to write some 

> If you paid attention to the code, you may have noticed the `#define K 0.4` statement line 5. Like in C, it's a macro to define a constant.

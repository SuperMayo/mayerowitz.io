...
And voila, our baby's born. You should now be ready to write some shaders of your own. If writing code is not your thing, you now have a better understanding of what's going under the hood of node shaders in [Blender shader nodes](https://docs.blender.org/manual/en/latest/render/shader_nodes/index.html) or [Unity Shader Graph](https://unity.com/features/shader-graph)

> If you paid attention to the code, you may have noticed the `#define K 0.4` statement line 5. Like in C, glsl support macro preprocessors.

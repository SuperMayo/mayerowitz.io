...
<svelte:head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Anonymous+Pro&family=Source+Sans+3:wght@400;500;700&family=Source+Serif+4&display=swap" rel="stylesheet">
</svelte:head>

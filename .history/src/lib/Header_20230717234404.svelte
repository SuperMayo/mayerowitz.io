...
<style lang="postcss">
  .flex-container {
    @apply flex flex-col justify-between p-one max-w-screen-lg sm:flex-row;
  }
  ...
  .nav-bar {
    @apply block max-h-0 opacity-0 -mt-one transition-all duration-500 ease-in-out sm:max-h-screen sm:opacity-100 sm:mt-0;
  }
  ...
  .menu {
    @apply text-right m-0 sm:flex sm:justify-start sm:text-left;
  }

...
<style lang="postcss">
  ...
  .nav-bar {
    @apply block max-h-0 opacity-0 -mt-one transition-all duration-200 ease-in-out;
  }

  .nav-bar.burger-on {
    @apply block translate-y-one max-h-screen opacity-100 transition-all duration-200 ease-in-out;
  }
  ...
  .menu-item {
    @apply mt-quarter transition-all duration-200 ease-in-out;
  }

   .nav-bar.burger-on .menu-item {
    @apply mt-half transition-all duration-200 ease-in-out;
  }
</style>

...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<main class="mx-auto text-justify max-w-xl font-mono md:mt-five mt-one">${validate_component(Blob_1, "Blob").$$render($$result, {}, {}, {})}
    <div class="px-5"><p>Hi, I’m <span class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-br transition-all duration-1000 ease-in-out from-black via-teal-600 to-black bg-[length:200%_200%] bg-[position:0%_0%] hover:bg-[position:100%_100%]">Antoine Mayerowitz</span>.</p>
